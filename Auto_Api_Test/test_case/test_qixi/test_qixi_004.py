...
class post_request(unittest.TestCase):
    ...
    # 查看回报信息
    def test_01(self):
        url='https://baogotest.turingsenseai.com/activity/doubleSeventhLottery'
        headers={'Authorization': "tokenmaolin",'content-type': 'application/x-protobuf'}
        info=NewBao_Activity_pb2.TSDoubleSeventhLotteryRequest()
        # info.pageNum = 1
        # info.pageSize = 10
        ...
        if r.status_code is 200:
            rep=NewBao_Activity_pb2.TSDoubleSeventhLotteryPoolResponse()
