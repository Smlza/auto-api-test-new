...
class post_request(unittest.TestCase):
    ...
    def test_01(self):
        url='https://baogotest.turingsenseai.com/activity/doubleSeventhEventPage'
        headers={'content-type': 'application/x-protobuf'}
        info=NewBao_Activity_pb2.TSDoubleSeventhEventPageRequest()
        # info.pageSize = 10
        # info.name = '七夕活动'
        ...
        if r.status_code is 200:
            rep=NewBao_Activity_pb2.TSDoubleSeventhEventPageResponse()
